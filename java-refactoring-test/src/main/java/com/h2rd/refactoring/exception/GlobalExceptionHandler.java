...
public class GlobalExceptionHandler {
   ...
   */
  @ExceptionHandler(com.h2rd.refactoring.exception.ResourceNotFoundException.class)
  public ResponseEntity<?> resourceNotFoundException(
      com.h2rd.refactoring.exception.ResourceNotFoundException ex, WebRequest request) {
